...
export const appwriteConfig = {
  ...
  projectId: "681a2e88002b261b8981",
  storageId: "664360cb00074ddf21ba",
  databaseId: "681a2e9a000a90fce96c",
  userCollectionId: "681a2ec400209e2ffcb2",
  ordersCollectionId: "681a3f1d000ab30392e6",
...
export async function updateOrder(order) {
  try {
    const result = await databases.updateDocument(
      ...
      appwriteConfig.ordersCollectionId, // collectionId
      order.$id, // documentId
      {
        title: order.title,
        adress: order.adress,
